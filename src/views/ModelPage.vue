    ...
    <div class="wrap" :style="{'background-color':themeBg}">
        <div class="model-gallery-container">
            <div class="model-container">
                <div class="model-title">
                    <div class="x3d-title">X3D Models</div>
                </div>
                <div class="model-content">
                    <div class="title-name">{{ `${currentModel} X3D Model` }}</div>
                    <div class="btn-area">
                    ...
                    <div class="model-describe-area">{{ `This X3D model of the ${modelName} has been created in 3ds Max, exported to VRML97 and converted, using the instantreality transcoders, to X3D for display online.` }}</div>
                </div>
            </div>
        ...
        <div class="control-center">
            <div class="control-item">
                ...
                <div class="ani-explain">These buttons select a limited range of X3D model viewpoints, use the dropdown menu for more camera views</div>
            </div>
            <div class="control-item">
                <div class="item-title">
                ...
                <div class="ani-explain">These buttons select a range of X3D animation options</div>
            </div>
            <div class="control-item">
                <div class="item-title">
